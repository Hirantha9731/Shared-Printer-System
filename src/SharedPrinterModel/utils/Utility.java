package SharedPrinterModel.utils;
...
public class Utility {
     ...
     */
    public static synchronized void log(Logger loggerProcess, String message, Boolean messageSuccessStatus) {
     ...
     */
    private static String generateLog(Logger loggerProcess, String message, Boolean messageSuccessStatus) {
     ...
     */
    private static String getLoggerProcessAsString(Logger loggerProcess) {
     ...
     */
    private static String getColorCode(Logger loggerProcess) {
        switch (loggerProcess) {
            case PRINTER:
